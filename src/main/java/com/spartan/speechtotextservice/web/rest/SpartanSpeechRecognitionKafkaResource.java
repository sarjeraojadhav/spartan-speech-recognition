...
@RestController
@RequestMapping("/api/spartan-speech-recognition-kafka")
public class SpartanSpeechRecognitionKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SpartanSpeechRecognitionKafkaResource.class);
    ...
    public SpartanSpeechRecognitionKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
